...
ActiveRecord::Schema.define(version: 2020_02_12_031204) do
  ...
  create_table "precedings", force: :cascade do |t|
    t.bigint "predecessor_id", null: false
    t.bigint "successor_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["predecessor_id"], name: "index_precedings_on_predecessor_id"
    t.index ["successor_id"], name: "index_precedings_on_successor_id"
  end
  ...
  add_foreign_key "precedings", "bits", column: "predecessor_id", on_delete: :cascade
  add_foreign_key "precedings", "bits", column: "successor_id", on_delete: :cascade
end
